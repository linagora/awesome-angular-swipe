      ...
      .directive('swipe', ['$timeout', '$swipe', function($timeout, $swipe) {
        return {
          ...
          link: function(scope, element, attrs) {
            ...
            function _controlSwipeContentVisiblity(visibility) {
              $timeout(function() {
                element.find('.swipe-content').css('opacity', visibility);
              }, transitionDuration);
            }

            scope.swipeClose = function() {
              updateTranslate3dX(0);
              _controlSwipeContentVisiblity(1);
              $timeout(function() {
            ...
            scope.transitionSwipeLeft = function() {
              ...
              _controlSwipeContentVisiblity(0);
            };
