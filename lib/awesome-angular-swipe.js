(function() {
  ...
  function awesomeAngularSwipe(angular, interact) {
    ...
    return angular.module('awesome-angular-swipe', [])
      .directive('swipe', ['$window', '$http', '$compile', '$templateCache', '$timeout', '$modal', 'deviceDetector', function($window, $http, $compile, $templateCache, $timeout, $modal, deviceDetector) {
        return {
          restrict: 'AC',
