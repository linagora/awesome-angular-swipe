(function() {
  ...
  function awesomeAngularSwipe(angular, interact) {

    return angular.module('awesome-angular-swipe', ['ng.deviceDetector'])
      ...
      .directive('swipe', ['$window', '$http', '$compile', '$templateCache', '$timeout', 'deviceDetector', function($window, $http, $compile, $templateCache, $timeout, deviceDetector) {
        return {
          restrict: 'AC',
